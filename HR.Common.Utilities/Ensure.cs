...
namespace HR.Common.Utilities
{
    ...
    /// The functions themselves are defined as extension methods to the <see cref="IEnsureArgument"/> interface and throw <see cref="ArgumentException"/>, or any of its derived classes, on failure.
    /// </summary>
